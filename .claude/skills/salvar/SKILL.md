...
1. Perguntar:
   ...
   > 2. Não, vou criar agora — me dá um nome pro repositório (ex: ep-advogados-associados)"

2. **Se opção 1:** rodar `git init`, `git add .`, `git commit -m "Setup inicial do projeto"`, `git branch -M main`, `git remote add origin <URL>`, `git push -u origin main`.
